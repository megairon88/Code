...
inputName = prompt("Nhap vao ten");
inputAddress = prompt("Nhap vao dia chi");
inputDate = prompt("Nhap vao ngay");

document.write(inputName +" thương nhớ," +
